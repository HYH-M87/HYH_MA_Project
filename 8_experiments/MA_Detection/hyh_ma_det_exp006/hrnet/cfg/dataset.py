...
data_root = "../Data/e_optha_MA/ProcessedData/MAimages_MergePatch(56,56)_to_(112,112)_overlap50.0_nan"
...
train_pipeline = [
    ...
    dict(type='RandomHSV',hue_delta=2, saturation_delta= 15, value_delta=50,prob=0.5),
