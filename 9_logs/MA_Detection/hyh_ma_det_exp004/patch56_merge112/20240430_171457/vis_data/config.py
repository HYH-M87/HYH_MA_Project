...
data_root = '../Data/e_optha_MA/ProcessedData/MAimages_MergePatch(56,56)_overlap50.0'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=
        '../Data/e_optha_MA/ProcessedData/MAimages_MergePatch(56,56)_overlap50.0',
        pipeline=[
...
work_dir = './9_logs/MA_Detection/hyh_ma_det_exp006'
