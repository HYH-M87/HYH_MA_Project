...
data_root = '../Data/e_optha_MA/ProcessedData/MAimages_CutPatch(112,112)_overlap70.0'
...
launcher = 'none'
load_from = '9_logs/MA_Detection/hyh_ma_det_exp003/epoch_100.pth'
log_level = 'INFO'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=
        '../Data/e_optha_MA/ProcessedData/MAimages_CutPatch(112,112)_overlap70.0',
        pipeline=[
...
work_dir = './9_logs/MA_Detection/hyh_ma_det_exp003/meanfilter_CLAHE'
